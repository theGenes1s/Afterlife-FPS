...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject drake_Prefab, vamp_Prefab;

    public Transform[] vamp_SpawnPoints, drake_SpawnPoints;

    [SerializeField]
    private int vamp_Enemy_Count, drake_Enemy_Count;

    private int initial_Vamp_Count, initial_Drake_Count;
